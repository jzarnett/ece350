...
\title{Lecture 9 --- Dynamic Memory Allocation}
...
Coalescence is just the process of merging two adjacent free blocks into one. 
...
\quad (2) keep the blocks sorted by size, though decreasing size this time. 
