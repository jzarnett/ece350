...
\texttt{ftrace} has restrictions: they can get called from anywhere and must avoid the risk of recursion resulting in an infinite loop or stack overflow. 
...
We need to allocate the shadow variable structure and deallocate them explicitly.
