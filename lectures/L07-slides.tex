...
\title{Lecture 7 --- Concurrency Control Implementation }
...
If the readers counter is 7, is that seven readers currently in the room or seven readers waiting to enter? 
