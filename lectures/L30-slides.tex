...
\title{Lecture 30 --- Reliability: Fail-Soft Operation }
...
It is also important to resist the pressure to drop or degrade these processes when under time pressure.
