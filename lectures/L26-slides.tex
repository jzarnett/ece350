...
\begin{frame}
\frametitle{Flash Translation Layer}
...
We know this bad: slow to erase.
...
The command is needed because many file systems work similar to C's approach to deallocation of memory.
