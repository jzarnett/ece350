...
The LFS approach seems like it works fine as long as everything works fine. But what if something goes wrong when writing to disk... like the power goes out? LFS addresses this by being prepared for such an eventuality and having a recovery strategy. Let's zoom out for a minute and talk about this in general to get started.
