...
It is clear from the formula that higher peak transfer rates and slower seek plus rotational latency (positioning time) result in a larger buffer, as does a larger target percentage. There's a temptation to push it to the limit and look for $F$ to be 0.99 or 0.999. And yet, we probably should not do that. 
