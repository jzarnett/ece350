...
Maybe that seems ridiculous in the modern era of 16, 32, 64~GB?
...
Data structures and collections may be declared to be very large even when it is not actually needed (e.g., the \texttt{ArrayList} in Java defaults to 10 elements.)
...
If performance of the computer is to be reasonable, say a degradation of less than 10\%, the page fault rate has to be very, very low. On the order of $10^{-6}$. 
