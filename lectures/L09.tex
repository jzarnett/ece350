...
\lecture{ 9 --- Dynamic Memory Allocation }{\term}{Jeff Zarnett}
...
As with best fit, we must either (1) check each available block; or (2) keep the blocks sorted by size, though decreasing size this time. A max heap is appropriate, or a binomial or Fibonacci heap could also be appropriate~\cite{mte241}.
