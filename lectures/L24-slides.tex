...
\title{Lecture 24 --- More About Input/Output Devices }
...
We've discussed the idea already that interrupts are more efficient than polling.\\
\quad You might question if there's such a thing as too responsive. 
