...
One of the most important determining factors is leakage: how much power is burned (for no good reason) when the core is active. Intel CPUs, allegedly, are big offenders in this area. For memory-bound work, slowdown might be better, though.
