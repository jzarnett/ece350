...
Based on a research paper~\cite{race-to-idle}, it is of course the case that there's variation based on workload. Customizing the approach, the authors claim, can net something like 13-18\% energy savings. 
