...
Imagine we have two programs numbered simply 1 and 2, each 16~KB in size.
...
We then add the area code to it to produce the \alert{physical address} (the actual location in memory and the address that is sent over the bus). 
