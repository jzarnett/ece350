...
\title{Lecture 13 --- Virtual Memory II }
...
And like unhappy workers who go on strike, unhappy processes start thrashing.
...
When it comes time to move to a new locale, the page fault rate rises until the program is ``settled'' in that new locale.
