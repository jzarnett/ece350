...
\title{Lecture 25 --- Disk Scheduling }
...
A set of tracks stacked vertically is called a cylinder. 
...
If enough low-numbered requests arrive during execution, a request at a high number may be put off, potentially indefinitely. 
