...
It then considers how this value compares to the ideal. 
...
If a process has $f$\% of the total tickets, then we can expect that process to get about $f$\% of the resource. 
...
A famous case of priority inversion took place on the Mars Pathfinder lander.
...
On a cache miss the CPU core can spend a lot of time (50\%?) waiting for that read to take place.
