...
The array being accessed at index $i$ now means it is likely that the array at index $i+1$ will be accessed soon.
...
The $R$ and $M$ bits can be used to build a paging algorithm.
...
Prefer to remove a page from the lowest-numbered class, when possible. 
